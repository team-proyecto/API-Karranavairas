...
INSERT INTO usuarios_casos (telefono,nombre,apellido,nacimiento,numero_documento,direccion_domicilio,codigo_confirmacion,condicion_uso,fecha_registro,distrito_id,tipo_documento_id,nacionalidad_id,gps_id,tipo_usuario_id,reporte_economico_id,reporte_medico_id,estado) VALUES('111111111','roman','delgado','2020-02-13','43795458','av. algun lugar 123,1era etapa Retablo. Comas',1234,true,'2020-02-13',2,1,1,2,2,2,2,true);

INSERT INTO usuarios_casos (telefono,nombre,apellido,nacimiento,numero_documento,direccion_domicilio,codigo_confirmacion,condicion_uso,fecha_registro,distrito_id,tipo_documento_id,nacionalidad_id,gps_id,tipo_usuario_id,reporte_economico_id,reporte_medico_id,estado) VALUES('222222222','jose','delgado','2020-02-13','43795458','av. algun lugar 123,1era etapa Retablo. Comas',1234,true,'2020-02-13',3,2,2,3,2,3,3,true);

INSERT INTO usuarios_casos (telefono,nombre,apellido,nacimiento,numero_documento,direccion_domicilio,codigo_confirmacion,condicion_uso,fecha_registro,distrito_id,tipo_documento_id,nacionalidad_id,gps_id,tipo_usuario_id,reporte_economico_id,reporte_medico_id,estado) VALUES('333333333','miguel','delgado','2020-02-13','43795458','av. algun lugar 123,1era etapa Retablo. Comas',1234,true,'2020-02-13',3,2,2,4,2,4,4,true);

INSERT INTO usuarios_casos (telefono,nombre,apellido,nacimiento,numero_documento,direccion_domicilio,codigo_confirmacion,condicion_uso,fecha_registro,distrito_id,tipo_documento_id,nacionalidad_id,gps_id,tipo_usuario_id,reporte_economico_id,reporte_medico_id,estado) VALUES('444444444','edinson','delgado','2020-02-13','43795458','av. algun lugar 123,1era etapa Retablo. Comas',1234,true,'2020-02-13',4,3,1,5,2,5,5,true);

INSERT INTO usuarios_casos (telefono,nombre,apellido,nacimiento,numero_documento,direccion_domicilio,codigo_confirmacion,condicion_uso,fecha_registro,distrito_id,tipo_documento_id,nacionalidad_id,gps_id,tipo_usuario_id,reporte_economico_id,reporte_medico_id,estado) VALUES('555555555','raul','delgado','2020-02-13','43795458','av. algun lugar 123,1era etapa Retablo. Comas',1234,true,'2020-02-13',4,3,1,6,2,6,6,true);
